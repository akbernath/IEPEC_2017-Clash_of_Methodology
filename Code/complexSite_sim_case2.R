...
######  FULLY SPECIFIED PRE-POST MODEL  ######
    ...
    ##  Estimate savings & SE(savings)
    FPP.mod.sav   <- -1*(FPP.mod$coeff[8]*sum(X.post$prog_ind) + 
                           FPP.mod$coeff[9]*sum(X.post$prog_x_prod1) +
                           FPP.mod$coeff[10]*sum(X.post$prog_x_prod2) +
                           FPP.mod$coeff[11]*sum(X.post$prog_x_noProd) +
                           FPP.mod$coeff[12]*sum(X.post$prog_x_prod1_x_HDD55)
                        )
    FPP.mod.bias   <- true.sav - FPP.mod.sav
    FPP.mod.pctErr <- FPP.mod.bias/true.sav
    FPP.cov.out    <- vcov(FPP.mod)
    FPP.mod.seSav  <- sqrt(FPP.cov.out[8,8]*sum(X.post$prog_ind)^2 +
                            FPP.cov.out[9,9]*sum(X.post$prog_x_prod1)^2 +
                            FPP.cov.out[10,10]*sum(X.post$prog_x_prod2)^2 +
                            FPP.cov.out[11,11]*sum(X.post$prog_x_noProd)^2 +
                            FPP.cov.out[12,12]*sum(X.post$prog_x_prod1_x_HDD55)^2 +

                            2*FPP.cov.out[8,9]*sum(X.post$prog_ind)*sum(X.post$prog_x_prod1) +
                            2*FPP.cov.out[8,10]*sum(X.post$prog_ind)*sum(X.post$prog_x_prod2) +
                            2*FPP.cov.out[8,11]*sum(X.post$prog_ind)*sum(X.post$prog_x_noProd) +
                            2*FPP.cov.out[8,12]*sum(X.post$prog_ind)*sum(X.post$prog_x_prod1_x_HDD55) +

                            2*FPP.cov.out[9,10]*sum(X.post$prog_x_prod1)*sum(X.post$prog_x_prod2) +
                            2*FPP.cov.out[9,11]*sum(X.post$prog_x_prod1)*sum(X.post$prog_x_noProd) +
                            2*FPP.cov.out[9,12]*sum(X.post$prog_x_prod1)*sum(X.post$prog_x_prod1_x_HDD55) +
                            
                            2*FPP.cov.out[10,11]*sum(X.post$prog_x_prod2)*sum(X.post$prog_x_noProd) +
                            2*FPP.cov.out[10,12]*sum(X.post$prog_x_prod2)*sum(X.post$prog_x_prod1_x_HDD55) +
                            
                            2*FPP.cov.out[11,12]*sum(X.post$prog_x_noProd)*sum(X.post$prog_x_prod1_x_HDD55)
                          )
