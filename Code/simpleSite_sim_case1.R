...
write.xlsx(simSummary, file.path(projPath,"Output","simData_simple - Case 1.xlsx"), 
           sheetName="Sim Out", col.names=T, row.names=F, append=F)
write.xlsx(overspec.sim, file.path(projPath,"Output","simData_simple - Case 1.xlsx"), 
